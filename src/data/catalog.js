...
export const products = [
  {
    ...
    ingredients:
      "Jowar, bajra, ragi, foxtail millet, spice blends, herbs, sea salt, sunflower oil (light coating).",
    nutrition: { serving: "35 g", protein: "8g", calories: "170 kcal", fat: "6g", carbs: "22g" },
    reviews: [
    ...
    variants: [
      {
        ...
        flipkart: "https://www.flipkart.com/search?q=the+great+indian+millet+box",
      },
    ],
  },
  {
    ...
    variants: [
      {
        ...
        flipkart: "https://www.flipkart.com/search?q=the+great+indian+protein+box",
      },
    ],
  },
  {
    ...
    variants: [
      {
        ...
        flipkart: "https://www.flipkart.com/search?q=roasted+kart+all+in+one+snack+box",
      },
    ],
  },
];
