        ...
        {items.length === 0 ? (
          ...
          <div className="grid gap-6 lg:grid-cols-[1fr_0.38fr]">
            ...
            <aside className="h-fit rounded-2xl border border-[#00000012] bg-white p-5">
              ...
              <button className="mt-5 w-full rounded-full bg-gradient-to-r from-[#ff7a00] to-[#ff3d81] px-5 py-3 text-sm font-black uppercase tracking-wide text-white">
                Checkout
              </button>
              <p className="mt-3 text-xs text-[#b9aacd]">Fast checkout coming soon.</p>
            </aside>
          </div>
        )}
      </div>
